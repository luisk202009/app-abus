  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Albus custom variants
        hero: "bg-primary text-primary-foreground hover:bg-gray-800 rounded-md shadow-medium hover:shadow-elevated active:scale-[0.98]",
        heroOutline: "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground rounded-md active:scale-[0.98]",
        nav: "text-foreground/80 hover:text-foreground hover:bg-transparent font-medium",
        navCta: "bg-primary text-primary-foreground hover:bg-gray-800 rounded-md font-medium",
      },
      size: {
        ...
        hero: "h-14 rounded-md px-8 text-base font-semibold",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
